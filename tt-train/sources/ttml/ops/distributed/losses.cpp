...
autograd::TensorPtr vocab_parallel_cross_entropy_loss(
    ...
    // Always subtract in FP32 — log_normalizer is FP32 and the FP32 → BF16
    // mixed-dtype subtract path produced ±inf in practice, so we materialise
    // the FP32 result and cast explicitly.  For MEAN we keep the FP32 tensor
