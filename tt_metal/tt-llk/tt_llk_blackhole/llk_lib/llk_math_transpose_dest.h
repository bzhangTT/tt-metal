...
inline void transpose_dest_32b()
{
    ...
    if constexpr (!transpose_of_faces)
    {
        ...
        lltt::replay(ckernel::math::replay_buf_offset + 8, 8);
        TTI_MOVB2D(0, 28, ADDR_MOD_0, p_movb2d::MOV_4_ROWS, 12); // Dest=32, SrcA=0

        // Transpose Face 2 hi bits and put back in Dest register.
        lltt::replay(ckernel::math::replay_buf_offset + 8, 8);
        TTI_MOVB2D(0, 28, ADDR_MOD_0, p_movb2d::MOV_4_ROWS, 12); // Dest=48, SrcA=0

        // Transpose Face 3 hi bits and put back in Dest register.
        lltt::replay(ckernel::math::replay_buf_offset + 8, 8);
        TTI_MOVB2D(0, 28, ADDR_MOD_3, p_movb2d::MOV_4_ROWS, 12); // Dest=0, SrcA=0
        ...
        TTI_MOVA2D(1, 16, ADDR_MOD_1, p_mova2d::MOV_8_ROWS, 16);
        TTI_MOVA2D(1, 24, ADDR_MOD_1, p_mova2d::MOV_8_ROWS, 24);
        TTI_MOVA2D(1, 32, ADDR_MOD_1, p_mova2d::MOV_8_ROWS, 32);
        TTI_MOVA2D(1, 40, ADDR_MOD_1, p_mova2d::MOV_8_ROWS, 40);
        TTI_MOVA2D(1, 48, ADDR_MOD_1, p_mova2d::MOV_8_ROWS, 48);
        TTI_MOVA2D(1, 56, ADDR_MOD_1, p_mova2d::MOV_8_ROWS, 56);
    }
    else
    {
        // Transpose Face 0 hi bits and put back in Dest register.
        ...
        TTI_MOVA2D(1, 0, ADDR_MOD_1, p_mova2d::MOV_8_ROWS, 0);
        TTI_MOVA2D(1, 8, ADDR_MOD_0, p_mova2d::MOV_8_ROWS, 8); // Dest=16, SrcA=0
        ...
        lltt::replay(ckernel::math::replay_buf_offset + 8, 5);
        TTI_MOVB2D(0, 16, ADDR_MOD_1, p_movb2d::MOV_4_ROWS, (0x3ff & (-16 + 0)));
        TTI_MOVB2D(0, 20, ADDR_MOD_1, p_movb2d::MOV_4_ROWS, (0x3ff & (-16 + 4)));
        TTI_MOVB2D(0, 24, ADDR_MOD_1, p_movb2d::MOV_4_ROWS, (0x3ff & (-16 + 8)));
        TTI_MOVB2D(0, 28, ADDR_MOD_1, p_movb2d::MOV_4_ROWS, (0x3ff & (-16 + 12))); // Dest=32, SrcA=0

        // Write transposed Face 1 hi bits and move to Face 2's area in Dest
        TTI_MOVA2D(0, 0, ADDR_MOD_1, p_mova2d::MOV_8_ROWS, 0);
        TTI_MOVA2D(0, 8, ADDR_MOD_0, p_mova2d::MOV_8_ROWS, 8); // Dest=48, SrcA=0

        // Transpose Face 3 hi bits and put back in Dest register
        lltt::replay(ckernel::math::replay_buf_offset + 8, 8);
        TTI_MOVB2D(0, 28, ADDR_MOD_3, p_movb2d::MOV_4_ROWS, 12);
        ...
        TTI_MOVA2D(1, 24, ADDR_MOD_1, p_mova2d::MOV_8_ROWS, 40);

        // Write transposed Face 2 low bits to Face 1's area in Dest
        TTI_MOVA2D(1, 32, ADDR_MOD_1, p_mova2d::MOV_8_ROWS, 16);
        TTI_MOVA2D(1, 40, ADDR_MOD_1, p_mova2d::MOV_8_ROWS, 24);
...
inline void _llk_math_transpose_dest_(const std::uint32_t dst_index)
{
    ...
    {
        transpose_dest_32b<is_fp32_dest_acc_en, transpose_of_faces>();
    }
    else
    {
