...
sfpi_inline void calculate_unary_max_min_float_body(
    ...
    TT_SFPSTORE(p_sfpu::LREG0, InstrModLoadStore::DEFAULT, ADDR_MOD_3, (dst_index_out - dst_index_in) * 32);
}
...
sfpi_inline void calculate_unary_max_min_int32_body(
    ...
    TT_SFPSTORE(p_sfpu::LREG0, InstrModLoadStore::INT32, ADDR_MOD_3, (dst_index_out - dst_index_in) * 32);
}
