...
void sort_noc_exchange_Wt_tiles(
    ...
    experimental::UnicastEndpoint remote_endpoint;
    experimental::CircularBuffer value_tensor_this_cb(value_tensor_this_cb_index);
    experimental::CircularBuffer index_tensor_this_cb(index_tensor_this_cb_index);
