...
void kernel_main() {
    ...
    experimental::CircularBuffer input_output_cb(input_tensor_output_cb_index);
    experimental::CircularBuffer index_output_cb(index_tensor_output_cb_index);
    experimental::CircularBuffer rm_output_value_cb(rm_output_value_cb_index);
    experimental::CircularBuffer rm_output_index_cb(rm_output_index_cb_index);
