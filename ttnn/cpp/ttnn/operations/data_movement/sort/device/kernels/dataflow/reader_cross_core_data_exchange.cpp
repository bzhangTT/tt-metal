...
void kernel_main() {
    ...
    experimental::CircularBuffer rm_input_cb(rm_input_cb_index);
    ...
    experimental::CircularBuffer index_output_cb(index_tensor_output_cb_index);
    experimental::CircularBuffer rm_index_output_cb(rm_index_output_cb_index);
    ...
    experimental::CircularBuffer physical_core_lookup_table_cb(physical_core_lookup_table_cb_index);
